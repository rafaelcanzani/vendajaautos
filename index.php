...
<head>
	...
	<meta name="google-site-verification" content="6N9Yu0ZP5tKKSwoApHbK3621CBeJJRt6ASwikgaafAE" />
...
<!-- End Google Tag Manager (noscript) -->
					...
					<div class="compressed">
						<div class="navbar-header">
							...
							<a href="#" class="navbar-brand compressed">
								<img src="assets/img/logo-horizontal.png" alt="" data-src="assets/img/logo-horizontal.png" data-src-retina="assets/img/logo-horizontal.png" style="" />
							</a>
						</div>
				...
				<div class="section">
					<div class="container">
						<div class="p-t-20 p-b-10">
							<h2 style="color:black;" class="text-center">Baixe o <span class="semi-bold">aplicativo</span>, e  <strong>VENDA</strong><font face="Arial" color="#00b8ff" class="bold">JÁ</font><span  face="Arial"> o seu veículo!</span>
							<div class="p-t-10"> 
				...
				<div class="section-sobre" style="background-color: #e3e3e3; margin-top: 1em;">
					<div class="container">
						<div class="row" style="padding-top: 2em;">
							<div class="col-md-12 feature-list " style="text-align:center">
				...
				<div class="p-t-30 p-b-50">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2  col-xs-12 xs-m-b-20">
							<div class="bold">Todos os Direitos Reservados © </div>
	...
	<script>
		if($('#myDropdown').is(":visible"))
			{
				$("#imgLogoHomeHorizontal").fadeIn(500);
				$("#imgLogoHome").hide();
			}
			else
			{
				$("#imgLogoHome").fadeIn(500);
				$("#imgLogoHomeHorizontal").hide();
			}
	</script>
</body>